...
import memoryGame from './memoryGameScreenShot.png'
      ...
      <h1>
        <div class='card'>
          <div class='front-face'>
            <img src={memoryGame} alt="" height='300px' width = '400px'/>
            <div class='Title'>Pairs</div>
          </div>
          {/* will be a grid display with two columns */}
          <div class='back-face'> 
          {/* need to find the github symbol for code */}
            <div class='github'>view code(github)</div>
            <div class='demo'>view app(github pages)</div>
          </div>
        </div>
      </h1>
    )
